...
# ✅ Initialize Roboflow
rf = Roboflow(api_key="qJTLU5ku2vpBGQUwjBx2") #ROBOFLOW API KEY
project = rf.workspace().project("cdio-golfbot2025")  #ROBOFLOW WORKSPACE
model = project.version(7).model  # Ensure this version exists
